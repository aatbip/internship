 ...
 */
const App = () => {
  //pass initial state to useState ie 0. useState returns variable (in our case -> number) and function (in our case -> setNumber)
  ...
  const increment = () => {
    //setNumber function accepts a callback that returns the current state
